...
对于绑定的布尔值和枚举值，Vue2 中有一些强制策略，而 Vue3 中取消了这一个策略。具体可以在下表中对照：

| 绑定表达式          | v2普通属性   | v2枚举属性          | v3普通属性      | v3枚举属性          |
| ------------------- | ------------ | ------------------- | --------------- | ------------------- |
| `:attr="null"`      | -            | `draggable="false"` | -               | -\*                 |
| `:attr="undefined"` | -            | -                   | -               | -                   |
| `:attr="true"`      | `foo="true"` | `draggable="true"`  | `foo="true"`    | `draggable="true"`  |
| `:attr="false"`     | -            | `draggable="false"` | `foo="false"`\* | `draggable="false"` |
| `:attr="0"`         | `foo="0"`    | `draggable="true"`  | `foo="0"`       | `draggable="0"`\*   |
| `attr=""`           | `foo=""`     | `draggable="true"`  | `foo=""`        | `draggable=""`\*    |
| `attr="foo"`        | `foo="foo"`  | `draggable="true"`  | `foo="foo"`     | `draggable="foo"`\* |
| `attr`              | `foo=""`     | `draggable="true"`  | `foo=""`        | `draggable=""`\*    |

> `-` 表示绑定会被移除；`*` 表示 V3 与 V2 有差别
